...
<head>
	<meta charset="utf-8" />
	<title>管理员登录--Nicko--景点旅游推荐论坛系统</title>
					...
					<form action="user/loginCheck.jsp" method="post">
						  ...
						  <div class="form-group" id="checked">
							<label class="radio-inline">
							  <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" checked>管理员登录
							</label>
							<label class="radio-inline">
							  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2">超级管理员登录
							</label>
						  </div>
						  <div class="form-group">
						      <div class="input">
						  ...
						  <div id="loginImmediately" class="form-group">
							  <a href="http://localhost:8080/travel/login.jsp"><label>普通登录</label></a>
						  </div>
					</form>
				</div>
			</div>
